...
ggplot(gap07, aes(x=lifeExp, y=pop)) + geom_point()
```


### Exercise 2

Visualize the relationship between life expectancy and population in 1952 using a scatter plot and color the points by continent.
